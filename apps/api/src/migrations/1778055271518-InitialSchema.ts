...
export class InitialSchema1778055271518 implements MigrationInterface {
  name = 'InitialSchema1778055271518';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "assets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "categoryId" uuid NOT NULL, "name" character varying NOT NULL, "capital" bigint DEFAULT '0', "metadata" jsonb, CONSTRAINT "PK_da96729a8b113377cfb6a62439c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    // Extra columns absorbed from later migrations
    await queryRunner.query(
